...
public class GraphHandler : MonoBehaviour
{
        ...
        {
            {
                ...
                Vector2 data = new Vector2(randomTemp, i/2);
                CreatePoint(new Vector2(i, randomTemp));
            }
        }
    ...
    {
        parentObject.transform.localScale = new Vector3(0.1f, 0.1f, 0.1f);
        canvas.renderMode = RenderMode.WorldSpace;
        Debug.Log("changed canvas");
    }
    private void Update()
    {
